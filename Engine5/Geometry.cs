namespace Engine {
    ...
    static class Geometry {
        ...
        //public static Vector4[] CreateNormals (Triangle4[] triangles) => Array.ConvertAll(triangles, CreateNormal);
        //public static Vector4 CreateNormal (Triangle4 t) => Vector4.Normalize(new(Vector3.Cross((t.B - t.A).Xyz(), (t.C - t.B).Xyz()), 0));
