...
#pragma warning disable CS0649
    private static readonly delegate*<int, void> glActiveTexture;
    private static readonly delegate*<int, bool> glIsBuffer;
    private static readonly delegate*<Capability, bool> glIsEnabled;
    private static readonly delegate*<int, bool> glIsProgram;
    private static readonly delegate*<int, bool> glIsShader;
    private static readonly delegate*<int, bool> glIsTexture;
    private static readonly delegate*<int, bool> glIsVertexArray;
    private static readonly delegate*<int, FramebufferTarget, FramebufferStatus> glCheckNamedFramebufferStatus;
    private static readonly delegate*<int, byte*, int> glGetAttribLocation;
    private static readonly delegate*<int, byte*, int> glGetFragDataLocation;
    private static readonly delegate*<int, byte*, int> glGetUniformLocation;
    private static readonly delegate*<int> glCreateProgram;
    private static readonly delegate*<ShaderType, int> glCreateShader;
    private static readonly delegate*<int, int, void> glAttachShader;
    private static readonly delegate*<BufferTarget, int, void> glBindBuffer;
    private static readonly delegate*<int, int, void> glBindFramebuffer;
    private static readonly delegate*<int, int, void> glBindRenderbuffer;
    private static readonly delegate*<int, int, void> glBindTexture;
    private static readonly delegate*<int, int, void> glBindTextureUnit;
    private static readonly delegate*<int, void> glBindVertexArray;
    private static readonly delegate*<int, long, void*, int, void> glBufferData;
    private static readonly delegate*<int, long, long, void*, void> glBufferSubData;
    private static readonly delegate*<BufferBit, void> glClear;
    private static readonly delegate*<float, float, float, float, void> glClearColor;
    private static readonly delegate*<int, void> glCompileShader;
    private static readonly delegate*<int, int*, void> glCreateBuffers;
    private static readonly delegate*<int, int*, void> glCreateFramebuffers;
    private static readonly delegate*<int, int*, void> glCreateRenderbuffers;
    private static readonly delegate*<int, int*, void> glCreateVertexArrays;
    private static readonly delegate*<int, int*, void> glDeleteBuffers;
    private static readonly delegate*<int, int*, void> glDeleteFramebuffers;
    private static readonly delegate*<int, int*, void> glDeleteTextures;
    private static readonly delegate*<int, int, int*, void> glCreateTextures;
    private static readonly delegate*<int, void> glCullFace;
    private static readonly delegate*<DebugProc, IntPtr, void> glDebugMessageCallback;
    private static readonly delegate*<int, void> glDeleteShader;
    private static readonly delegate*<int, void> glDeleteProgram;
    private static readonly delegate*<DepthFunction, void> glDepthFunc;
    private static readonly delegate*<Primitive, int, int, void> glDrawArrays;
    private static readonly delegate*<Primitive, long, void> glDrawArraysIndirect;
    private static readonly delegate*<Primitive, int, int, int, void> glDrawArraysInstanced;
    private static readonly delegate*<int, Attachment*, void> glDrawBuffers;
    private static readonly delegate*<Capability, void> glEnable;
    private static readonly delegate*<Capability, void> glDisable;
    private static readonly delegate*<int, int, void> glEnableVertexArrayAttrib;
    private static readonly delegate*<int, int, void> glDisableVertexArrayAttrib;
    private static readonly delegate*<void> glFlush;
    private static readonly delegate*<void> glFinish;
    private static readonly delegate*<bool, void> glDepthMask;
    private static readonly delegate*<int, ProgramParameter, int*, void> glGetProgramiv;
    private static readonly delegate*<int, ShaderParameter, int*, void> glGetShaderiv;
    private static readonly delegate*<int, int, int*, byte*, void> glGetProgramInfoLog;
    private static readonly delegate*<int, int, int*, byte*, void> glGetShaderInfoLog;
    private static readonly delegate*<int, int, int, int*, int*, UniformType*, byte*, void> glGetActiveUniform;
    private static readonly delegate*<int, int, int, int*, int*, AttribType*, byte*, void> glGetActiveAttrib;
    private static readonly delegate*<int, int*, void> glGetIntegerv;
    private static readonly delegate*<int, void> glLinkProgram;
    private static readonly delegate*<int, long, void*, int, void> glNamedBufferStorage;
    private static readonly delegate*<int, long, long, void*, void> glNamedBufferSubData;
    private static readonly delegate*<int, int, byte**, int*, void> glShaderSource;
    private static readonly delegate*<int, int, int, int, int, int, int, int, void*, void> glTexImage2D;
    private static readonly delegate*<int, int, int, int, int, int, int, int, void*, void> glTexSubImage2D;
    private static readonly delegate*<int, int, float, void> glTextureParameterf;
    private static readonly delegate*<int, int, int, void> glTextureParameteri;
    private static readonly delegate*<int, int, TextureInternalFormat, int, int, void> glTextureStorage2D;
    private static readonly delegate*<int, int, int, int, int, int, int, int, byte*, void> glTextureSubImage2D;
    private static readonly delegate*<int, int, void> glUniform1i;
    private static readonly delegate*<int, int, int, void> glUniform2i;
    private static readonly delegate*<int, float, void> glUniform1f;
    private static readonly delegate*<int, float, float, void> glUniform2f;
    private static readonly delegate*<int, float, float, float, void> glUniform3f;
    private static readonly delegate*<int, float, float, float, float, void> glUniform4f;
    private static readonly delegate*<int, int, int*, void> glUniform1iv;
    private static readonly delegate*<int, int, float*, void> glUniform1fv;
    private static readonly delegate*<int, int, int*, void> glUniform2iv;
    private static readonly delegate*<int, int, float*, void> glUniform2fv;
    private static readonly delegate*<int, long, bool, Matrix4x4, void> glUniformMatrix4fv;
    private static readonly delegate*<int, void> glUseProgram;
    private static readonly delegate*<int, int, void> glVertexAttribDivisor;
    private static readonly delegate*<int, int, AttribType, bool, int, long, void> glVertexAttribPointer;
    private static readonly delegate*<int, int, int, int, void> glViewport;
    private static readonly delegate*<int, TextureParameter, float*, void> glGetTextureParameterfv;
    private static readonly delegate*<int, TextureParameter, int*, void> glGetTextureParameteriv;
