...
#pragma warning disable CS0649
    ...
    private static readonly glDeleteArray glDeleteFramebuffers;
...
#pragma warning restore CS0649
    ...
    public static void DeleteFramebuffers (int[] framebuffers) => glDeleteFramebuffers(framebuffers.Length, framebuffers);
    ...
    private static Delegate GetDelegate (FieldInfo f) => Marshal.GetDelegateForFunctionPointer(GetProcAddress(f.Name), f.FieldType) ?? throw new ApplicationException($"failed to create delegate for {f.Name}");
    static Calls () {
