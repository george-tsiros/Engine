...
public static class Glfw {
    ...
    public static ErrorCode GetError (out string description) {
        ...
        description = code == ErrorCode.None ? null : Util.PtrToStringUni(ptr);
        return code;
    }
    /// <summary>
    ...
    public static string GetJoystickGuid (int joystickId) {
        ...
        return ptr == IntPtr.Zero ? null : Util.PtrToStringUni(ptr);
    }
    /// <summary>
    ...
    ///     The version string.
    /// </value>
    public static string VersionString => Util.PtrToStringUni(GetVersionString());
    /// <summary>
    ...
    public static string GetClipboardString (Window window) {
        return Util.PtrToStringUni(GetClipboardStringInternal(window));
    }
    /// <summary>
    ...
    public static string GetJoystickName (Joystick joystick) {
        return Util.PtrToStringUni(GetJoystickNameInternal(joystick));
    }
    /// <summary>
    ...
    public static string GetKeyName (Keys key, int scanCode) {
        return Util.PtrToStringUni(GetKeyNameInternal(key, scanCode));
    }
    /// <summary>
    ...
    public static string GetMonitorName (Monitor monitor) {
        return Util.PtrToStringUni(GetMonitorNameInternal(monitor));
    }
    /// <summary>
